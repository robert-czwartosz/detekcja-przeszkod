...
if __name__ == '__main__':
    ...
    def num():
        ...
        if Stop==False: # and i <5200
            ...
            with open("plik.txt", 'w') as out:
                out.write(str(ex.root_path / ex.kitti_info['img_path']))
            # print(str(ex.root_path / ex.kitti_info['img_path']))
